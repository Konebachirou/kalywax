...
class NewsletterSubscriberPolicy
{
    ...
    {
        return $user->can('view_any_newsletter::subscriber');
    }
    ...
    {
        return $user->can('view_newsletter::subscriber');
    }
    ...
    {
        return $user->can('create_newsletter::subscriber');
    }
    ...
    {
        return $user->can('update_newsletter::subscriber');
    }
    ...
    {
        return $user->can('delete_newsletter::subscriber');
    }
    ...
    {
        return $user->can('delete_any_newsletter::subscriber');
    }
    ...
    {
        return $user->can('force_delete_newsletter::subscriber');
    }
    ...
    {
        return $user->can('force_delete_any_newsletter::subscriber');
    }
    ...
    {
        return $user->can('restore_newsletter::subscriber');
    }
    ...
    {
        return $user->can('restore_any_newsletter::subscriber');
    }
    ...
    {
        return $user->can('replicate_newsletter::subscriber');
    }
    ...
    {
        return $user->can('reorder_newsletter::subscriber');
    }
